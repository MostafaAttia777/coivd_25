...
public class Adptar_Syptomes_prv extends RecyclerView.Adapter<Adptar_Syptomes_prv.box_vh> {

    public Adptar_Syptomes_prv(ArrayList<Model_home> model_homes) {
    ...
    public box_vh onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custome_prevebtion, parent, false);
    ...
    class box_vh extends RecyclerView.ViewHolder {
        ...
        public box_vh(@NonNull View itemView) {
            super(itemView);
            imageView = itemView.findViewById(R.id.image_prevevntion);
            textView = itemView.findViewById(R.id.text_prevevntion);
        }
    }
}
